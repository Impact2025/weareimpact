        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            <section className="mb-12">
              ...
              <p className="text-lg text-slate-700 mb-6 p-4 bg-orange-50 border-l-4 border-orange-500 rounded-r">
            ...
            <section className="mb-12">
              ...
              <h3 className="text-xl font-medium text-slate-800 mt-6 mb-3">2.1 Contactgegevens</h3>
              ...
              <h3 className="text-xl font-medium text-slate-800 mt-6 mb-3">2.2 Communicatiegegevens</h3>
              <ul className="list-disc pl-6 space-y-1 text-slate-700">
              ...
              <h3 className="text-xl font-medium text-slate-800 mt-6 mb-3">2.3 Technische gegevens</h3>
              <ul className="list-disc pl-6 space-y-1 text-slate-700">
              ...
              <h3 className="text-xl font-medium text-slate-800 mt-6 mb-3">2.4 AI-scan gegevens</h3>
              <ul className="list-disc pl-6 space-y-1 text-slate-700">
              ...
              <table className="w-full border-collapse mb-4">
                <thead>
                  <tr className="bg-slate-100">
                    <th className="border border-slate-200 p-3 text-left font-semibold">Doeleinde</th>
                    <th className="border border-slate-200 p-3 text-left font-semibold">Grondslag</th>
                  </tr>
                </thead>
                <tbody className="text-slate-700">
                  <tr>
                    <td className="border border-slate-200 p-3">Uitvoeren van overeenkomsten</td>
                    <td className="border border-slate-200 p-3">Uitvoering overeenkomst</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Beantwoorden van vragen</td>
                    <td className="border border-slate-200 p-3">Gerechtvaardigd belang</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Versturen van nieuwsbrieven</td>
                    <td className="border border-slate-200 p-3">Toestemming</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Verbeteren van onze website</td>
                    <td className="border border-slate-200 p-3">Gerechtvaardigd belang</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Facturatie en administratie</td>
                    <td className="border border-slate-200 p-3">Wettelijke verplichting</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">AI-scan en advies op maat</td>
                    <td className="border border-slate-200 p-3">Toestemming / Uitvoering</td>
                  </tr>
                </tbody>
              </table>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-700 mt-4">
                U kunt altijd verzoeken om verwijdering van uw chatgeschiedenis via <a href="mailto:v.munster@weareimpact.nl" className="text-orange-600 hover:underline">v.munster@weareimpact.nl</a>.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <table className="w-full border-collapse mb-4">
                <thead>
                  <tr className="bg-slate-100">
                    <th className="border border-slate-200 p-3 text-left font-semibold">Type gegevens</th>
                    <th className="border border-slate-200 p-3 text-left font-semibold">Bewaartermijn</th>
                  </tr>
                </thead>
                <tbody className="text-slate-700">
                  <tr>
                    <td className="border border-slate-200 p-3">Klantgegevens</td>
                    <td className="border border-slate-200 p-3">7 jaar na laatste contact (fiscale verplichting)</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Contactformulier berichten</td>
                    <td className="border border-slate-200 p-3">2 jaar</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Chat-conversaties</td>
                    <td className="border border-slate-200 p-3">1 jaar</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Nieuwsbrief abonnees</td>
                    <td className="border border-slate-200 p-3">Tot uitschrijving + 1 jaar</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">AI-scan resultaten</td>
                    <td className="border border-slate-200 p-3">2 jaar</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Website analytics</td>
                    <td className="border border-slate-200 p-3">26 maanden (Google Analytics)</td>
                  </tr>
                </tbody>
              </table>
            </section>
            ...
            <section className="mb-12">
              ...
              <table className="w-full border-collapse mb-4">
                <thead>
                  <tr className="bg-slate-100">
                    <th className="border border-slate-200 p-3 text-left font-semibold">Partij</th>
                    <th className="border border-slate-200 p-3 text-left font-semibold">Doel</th>
                    <th className="border border-slate-200 p-3 text-left font-semibold">Locatie</th>
                  </tr>
                </thead>
                <tbody className="text-slate-700">
                  <tr>
                    <td className="border border-slate-200 p-3">Vercel</td>
                    <td className="border border-slate-200 p-3">Website hosting</td>
                    <td className="border border-slate-200 p-3">EU/VS (Privacy Shield)</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Google Analytics</td>
                    <td className="border border-slate-200 p-3">Website statistieken</td>
                    <td className="border border-slate-200 p-3">EU/VS (SCCs)</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">OpenRouter/OpenAI</td>
                    <td className="border border-slate-200 p-3">AI-chatbot</td>
                    <td className="border border-slate-200 p-3">VS (DPA)</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3">Google Calendar</td>
                    <td className="border border-slate-200 p-3">Afspraakplanning</td>
                    <td className="border border-slate-200 p-3">EU/VS (SCCs)</td>
                  </tr>
                </tbody>
              </table>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-700 mt-4">
                Om uw rechten uit te oefenen, stuurt u een e-mail naar <a href="mailto:v.munster@weareimpact.nl" className="text-orange-600 hover:underline">v.munster@weareimpact.nl</a>. Wij reageren binnen 30 dagen op uw verzoek.
              </p>
            </section>
