---
slug: cultuurverandering-top-down-inside-out
title: "Van top-down naar inside-out: cultuurverandering in welzijnsorganisaties"
subtitle: "Waarom echte verandering van binnenuit moet komen"
excerpt: "Ik heb cultuurtrajecten gezien die miljoenen kostten en niks opleverden. En ik heb verandering gezien die begon met drie mensen en de hele organisatie transformeerde. Het verschil? Inside-out versus top-down."
...
seo_title: "Cultuurverandering Welzijnsorganisaties | Van Top-Down naar Inside-Out"
seo_description: "Hoe realiseer je echte cultuurverandering in welzijnsorganisaties? Van top-down mandaten naar inside-out beweging die beklijft."
seo_keywords:
  - cultuurverandering welzijn
  - organisatieverandering non-profit
  - inside-out verandering
...
1. [Waarom top-down cultuurverandering faalt](#waarom)
2. [Het inside-out alternatief](#inside-out)
3. [De 5 principes](#principes)
4. [Het praktische stappenplan](#stappenplan)
5. [Praktijkvoorbeeld: Stichting de Baan](#voorbeeld)
...
De organisatiepsycholoog [Edgar Schein](https://mitsloan.mit.edu/faculty/directory/edgar-h-schein) beschreef cultuur als het onzichtbare immuunsysteem van een organisatie. Het stoot vreemde lichamen af - ook nieuwe waarden die van boven worden opgelegd.
...
| Top-down leider | Inside-out leider |
|-----------------|-------------------|
| Bedenkt de verandering | Herkent de beweging |
| Legt op | Faciliteert |
| Controleert | Beschermt |
| Beloont compliance | Viert initiatief |
...
**Niet:** Consultants die komen vertellen hoe het moet.
**Wel:** Tijd nemen om te begrijpen wat er leeft.
...
- [Appreciative Inquiry](https://cvdl.case.edu/ai-courses/) sessies
- Luistercafés

**Vraag niet:** "Wat moet er anders?"
**Vraag wel:** "Wanneer werkt het hier het beste? Wat maakt dat mogelijk?"
...
Verandering vraagt risico nemen. Risico nemen vraagt veiligheid. [Amy Edmondson](https://amycedmondson.com/) noemt dit "psychological safety".
...
### Organisatie
4. Is er ruimte voor experimenten?
5. Zijn er pioniers aanwezig?
6. Is de urgentie duidelijk?

### Resources
7. Is er tijd beschikbaar (10% van mensen)?
8. Is er budget voor begeleiding indien nodig?
9. Is er een trekker die dit kan begeleiden?
