---
slug: vrijwilligerscheck-talenten-matchen
title: "De VrijwilligersCheck: hoe je talenten matcht in plaats van gaten vult"
subtitle: "Methodiek voor betekenisvol vrijwilligerswerk dat past bij de persoon"
excerpt: "De meeste organisaties zoeken vrijwilligers om gaten te vullen. Wij draaiden het om: we kijken eerst naar talenten en zoeken dan de beste plek. Het resultaat? 35% meer retentie en gelukkigere vrijwilligers."
...
tags:
  ...
  - VrijwilligersCheck
  - methodiek
seo_title: "VrijwilligersCheck | Talenten Matchen voor Betere Retentie"
seo_description: "Ontdek de VrijwilligersCheck methodiek: match vrijwilligers op talenten, niet op vacatures. Verhoog retentie met 35% door betekenisvol vrijwilligerswerk."
seo_keywords:
  - vrijwilligerscheck
  - vrijwilligers matchen
  - talenten vrijwilligers
...
1. [Het probleem met vacature-denken](#probleem)
2. [De VrijwilligersCheck methodiek](#methodiek)
3. [De 5 dimensies](#dimensies)
4. [Het intake-gesprek](#intake)
5. [Van profiel naar match](#match)
6. [Implementeren in je organisatie](#implementeren)
...
Uit onderzoek van [Volunteer Hub](https://www.volunteerhub.com/) en mijn eigen ervaring met 180+ vrijwilligers blijkt dat succesvolle matches aan alle vijf voldoen:
...
| Type | Kenmerken | Past goed bij |
|------|-----------|---------------|
| **Zingeving** | Wil bijdragen aan de wereld | Directe hulpverlening |
| **Sociale** | Zoekt contact en verbinding | Groepsactiviteiten |
| **Ontwikkeling** | Wil leren en groeien | Uitdagende taken |
| **Structuur** | Zoekt dagritme en routine | Vaste taken/tijden |
| **Netwerk** | Wil mensen ontmoeten | Evenementen, netwerk |
...
| Interest | Passende activiteiten |
|----------|----------------------|
| Buitenleven | Wandelmaatje, tuingroep |
| Cultuur | Museum-uitjes, voorlezen |
| Sport | Sportbegeleiding, bewegen |
| Koken | Kookclub, maaltijden bereiden |
| Technologie | Digitale hulp, website-ondersteuning |
...
|--------|------|-----|-------------|
| Uitval eerste jaar | 30% | 19% | 35% minder |
| Gemiddelde duur | 2,1 jaar | 3,4 jaar | 62% langer |
| Tevredenheid | 7,2 | 8,4 | +1,2 punt |
...
Van: "We hebben een gat, wie past erin?"
Naar: "We hebben een mens, waar past die het best?"
