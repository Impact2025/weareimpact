---
slug: fondsenwerving-voor-sociale-organisaties
title: "Fondsenwerving voor sociale organisaties: wat echt werkt"
subtitle: "Van cold calling naar warme relaties - een praktische aanpak die fondsen niet irriteert"
excerpt: "Ik heb honderdduizenden euro's aan fondsen binnengehaald. Niet door de beste aanvragen te schrijven, maar door relaties te bouwen. In dit artikel deel ik wat ik heb geleerd over fondsenwerving die werkt."
...
tags:
  ...
  - vermogensfondsen
  - filantropie
seo_title: "Fondsenwerving voor Sociale Organisaties | Praktische Gids"
seo_description: "Leer hoe je effectief fondsen werft voor je sociale organisatie. Van strategie tot uitvoering, met praktische tips van een ervaren fondsenwerver."
seo_keywords:
  - fondsenwerving
  - vermogensfondsen aanvragen
  - fondsen werven
...
1. [Waarom de meeste fondsenwerving faalt](#waarom-faalt)
2. [De relatie-eerst aanpak](#relatie-eerst)
3. [Je fonds-portfolio bouwen](#portfolio)
4. [De aanvraag die werkt](#aanvraag)
5. [Na de toekenning](#na-toekenning)
6. [De cijfers die je moet kennen](#cijfers)
...
1. Zoek alle fondsen die bij je passen
2. Stuur dezelfde aanvraag naar allemaal
3. Hoop dat er een paar bijten
4. Wees verbaasd als het niet werkt
...
**Slecht:** "Wij willen eenzaamheid onder ouderen bestrijden."
**Goed:** "Wij willen 50 ouderen 75+ in Amsterdam-Noord wekelijks koppelen aan een vrijwilliger, resulterend in 2.600 contactmomenten per jaar."

### Principe 2: Toon track record

**Slecht:** "Wij geloven dat dit gaat werken."
**Goed:** "In 2023 bereikten we 700 ouderen met vergelijkbare interventies. 73% rapporteerde minder eenzaamheid (gemeten met UCLA Loneliness Scale)."

### Principe 3: Wees eerlijk over risico's

**Slecht:** Negeren dat er risico's zijn.
**Goed:** "Het risico is dat we niet alle 50 ouderen bereiken. Onze mitigatie: we starten met een kern van 20 via bestaande netwerken."
